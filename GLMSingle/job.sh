...
#SBATCH --time=07:30:00                        # More realistic time for GLM fitting
#SBATCH --mem=64G                              # Increase memory for fMRI data, safer for large jobs
...
# Run your script
python beta_estimation_curta_memory.py
